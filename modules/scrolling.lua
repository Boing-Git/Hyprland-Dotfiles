...
hl.bind(MM .. " + " .. TM .. " + " .. left, hl.dsp.layout("colresize -0.1"))
hl.bind(MM .. " + " .. TM .. " + " .. right, hl.dsp.layout("colresize +0.1"))
...
--------------------------------------------------------------------------------
hl.bind(MM .. " + v", hl.dsp.layout("fit_into_view"))
...
--------------------------------------------------------------------------------
hl.bind(MM .. " + c", hl.dsp.layout("consume"))
